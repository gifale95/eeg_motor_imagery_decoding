...
data_dir = os.path.join(args.project_dir, 'datasets', '5f', 'data', 'used_data')
...
### Converting to MNE format and resampling ###
...
### Creating the raw data annotations ###
	...
	annotations = mne.annotations_from_events(events, args.sfreq,
...
### Windowing the data ###
	...
	trial_start_offset_samples = int(trial_start_offset_seconds * args.sfreq)
